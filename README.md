# Homecontrol_device
🏠 Bluetooth-Based Home Control System using ThingSpeak
...
💡 Control multiple electrical devices such as lights, fans, and other appliances.
📊 Live monitoring of device status through cloud dashboards.
⚡ Low-cost and energy-efficient home automation solution.
🔒 Reliable communication between hardware and cloud platform.
...
☁️ Device status and sensor data are uploaded to ThingSpeak.
📊 Users can monitor real-time information through the ThingSpeak dashboard.

🎯 Objectives
🏡 Develop a smart home automation system using IoT technologies.
📱 Enable wireless control of electrical appliances.
☁️ Store and monitor real-time data using the cloud.
⚡ Improve convenience, energy efficiency, and automation.
